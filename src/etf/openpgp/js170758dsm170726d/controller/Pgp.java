...
public interface Pgp {
	...
	public void sendMessage(String fileName, Long signatureKeyID,char[] pass,List<Long> encryptKeyIDs,String algorithm,boolean compress, boolean convertToRadix64);
